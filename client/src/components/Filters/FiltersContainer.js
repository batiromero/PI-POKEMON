...
import {setPokemonsOrder, setPokemonsOrigin, setPokemonsType} from '../../actions';

const FiltersContainer = ({	setPokemonsOrder, setPokemonsOrigin, setPokemonsType, pokemonsTypes,
